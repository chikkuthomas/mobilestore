...
class Mobile(models.Model):
    ...
    brand=models.ForeignKey(Brand,on_delete=models.CASCADE,null=True)  #Foreignkey to refer another model
                                                                 #CASACADE= if brand is deleted this data also get deleted
